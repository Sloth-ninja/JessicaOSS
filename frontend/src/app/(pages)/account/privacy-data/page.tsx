...
export default function PrivacyDataPage() {
    ...
    const handleExportAccountData = async () => {
        ...
        try {
            ...
            downloadBlob(blob, filename ?? "jessicaoss-account-export.json");
        } catch (error) {
    ...
    const handleExportChatData = async () => {
        ...
        try {
            ...
            downloadBlob(blob, filename ?? "jessicaoss-chat-export.json");
        } catch (error) {
    ...
    const handleExportTabularReviewsData = async () => {
        ...
        try {
            ...
            downloadBlob(blob, filename ?? "jessicaoss-tabular-reviews-export.json");
        } catch (error) {
